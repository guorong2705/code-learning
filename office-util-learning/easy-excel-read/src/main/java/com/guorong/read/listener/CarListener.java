 ...
 * @author guorong
 */
public class CarListener extends AnalysisEventListener<Car> {
     ...
     * 临时数据容器
     */
    private List<Car> dataList = new ArrayList<>(BATCH_COUNT);
    ...
    public CarListener(BaseDao baseDao) {
    ...
    public void invoke(Car car, AnalysisContext analysisContext) {
        System.out.println("解析到一条数据 =============>>" + car.toString());
